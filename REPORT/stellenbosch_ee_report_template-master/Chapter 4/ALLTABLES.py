...
# # # # # # # # plt.xlabel('Dataset')
# # # # # # # # plt.ylabel('RMSE Lat-Lon Error (m)')
...
# # # # # # # plt.title('Radial Lat-Lon RMSE Comparison Across Datasets for Translational Methods')
# # # # # # # plt.xlabel('Dataset')
# # # # # # # plt.ylabel('RMSE Lat-Lon Error (m)')
...
# # # # # plt.title('RMSE Lat-Lon Error Comparison Across Datasets for Various Methods')
# # # # # plt.xlabel('Dataset')
# # # # # plt.ylabel('RMSE Lat-Lon Error (m)')
# # # # # plt.xticks(rotation=45)
# # # # # plt.grid()
...
# # # # # plt.title('Percentage Change in Lat-Lon Error with 10-degree Rotational Offset')
# # # # # plt.xlabel('Dataset')
...
# Title and labels
plt.title('Radial Accuracy for Various Outlier Techniques', fontsize=26)
plt.xlabel('Dataset', fontsize=22)
plt.ylabel('Radial RMSE (m)', fontsize=22)
plt.xticks(rotation=45, fontsize=18)
plt.yticks(fontsize=18)
plt.grid()
plt.legend(fontsize=18)
plt.tight_layout()
plt.savefig('./REPORT/stellenbosch_ee_report_template-master/Chapter 4/testresults/rmse_outlier_methods.png')
plt.close()
...
# Title and labels
plt.title('Runtime for Various Outlier Techniques', fontsize=26)
plt.xlabel('Dataset', fontsize=22)
...
plt.legend(fontsize=18)
plt.tight_layout()
plt.savefig('./REPORT/stellenbosch_ee_report_template-master/Chapter 4/testresults/runtime_outlier_methods.png')
plt.close()
...
# Title and labels for RMSE
plt.title('Radial Error for Various Translational Methods', fontsize=26)
plt.xlabel('Dataset', fontsize=22)
plt.ylabel('Radial RMSE (m)', fontsize=22)
plt.xticks(rotation=45, fontsize=18)
plt.yticks(fontsize=18)
...
# Title and labels for Runtime
plt.title('Runtime for Various Translational Methods', fontsize=26)
plt.xlabel('Dataset', fontsize=22)
plt.ylabel('Runtime (s)', fontsize=22)
plt.xticks(rotation=45, fontsize=18)
plt.yticks(fontsize=18)
...
# Title and labels for RMSE Comparison
plt.title('Radial Error for Global Matchers', fontsize=26)
plt.xlabel('Dataset', fontsize=22)
plt.ylabel('Radial RMSE (m)', fontsize=22)
plt.xticks(rotation=45, fontsize=18)
plt.yticks(fontsize=18)
...
# Title and labels for Percentage Change Comparison
plt.title('Percentage Change in Error with 10-degree Rotational Skew', fontsize=26)
plt.xlabel('Dataset', fontsize=22)
plt.ylabel('Change radial RMSE (%)', fontsize=22)
plt.xticks(rotation=45, fontsize=18)
plt.yticks(fontsize=18)
plt.grid()
plt.legend(fontsize=18)
...
plt.plot(datasets, histogram_rmse, marker='o', label='Histogram', color='orange')
plt.plot(datasets, ssim_rmse, marker='o', label='SSIM', color='green')
plt.title('Radial RMSE for Various Global Matchers', fontsize=26)
plt.xlabel('Dataset', fontsize=22)
plt.ylabel('Radial RMSE (m)', fontsize=22)
plt.xticks(rotation=45, fontsize=18)
plt.yticks(fontsize=18)
...
plt.plot(datasets, histogram_runtime, marker='o', label='Histogram', color='orange')
plt.plot(datasets, ssim_runtime, marker='o', label='SSIM', color='green')
plt.title('Runtime for Various Global Matching Techniques', fontsize=26)
plt.xlabel('Dataset', fontsize=22)
plt.ylabel('Runtime (s)', fontsize=22)
plt.xticks(rotation=45, fontsize=18)
plt.yticks(fontsize=18)
...
# plt.title('Radial Error for different Rotational Estimators', fontsize=26)
# plt.xlabel('Dataset', fontsize=22)
# plt.ylabel('Radial RMSE Lat-Lon (m)', fontsize=22)
# plt.xticks(rotation=45, fontsize=18)
# plt.yticks(fontsize=18)
# plt.legend(fontsize=18)
# plt.grid()
...
# plt.title('Runtime for Various Rotational Estimators', fontsize=26)
# plt.xlabel('Dataset', fontsize=22)
# plt.ylabel('Runtime (s)', fontsize=22)
# plt.xticks(rotation=45, fontsize=18)
# plt.yticks(fontsize=18)
...
# plt.title('Radial Error for Various Local Matchers', fontsize=26)
# plt.xlabel('Dataset', fontsize=22)
# plt.ylabel('Radial RMSE Lat-Lon (m)', fontsize=22)
# plt.xticks(rotation=45, fontsize=18)
# plt.yticks(fontsize=18)
...
# plt.title('Runtime for Various Local Matchers (s)', fontsize=26)
# plt.xlabel('Dataset', fontsize=22)
# plt.ylabel('Runtime (s)', fontsize=22)
# plt.xticks(rotation=45, fontsize=18)
# plt.yticks(fontsize=18)
...
# plt.title('Radial Error for Various Local Detectors (m)', fontsize=26)
# plt.xlabel('Dataset', fontsize=22)
# plt.ylabel('Radial RMSE Lat-Lon (m)', fontsize=22)
# plt.xticks(rotation=45, fontsize=18)
# plt.yticks(fontsize=18)
...
# plt.title('Runtime for Various Feature Detectors (s)', fontsize=26)
# plt.xlabel('Dataset', fontsize=22)
# plt.ylabel('Runtime (s)', fontsize=22)
# plt.xticks(rotation=45, fontsize=18)
# plt.yticks(fontsize=18)
...
# # Night and Evening RMSE Lat-Lon values
...
# plt.figure(figsize=(10, 6))
# plt.plot(datasets, night_rmse_GPS, marker='o', label='Night RMSE Lat-Lon (m)', color='purple')
# plt.plot(datasets, evening_rmse_GPS, marker='o', label='Evening RMSE Lat-Lon (m)', color='orange')
# plt.title('Radial Errors for Various lightings', fontsize=26)
# plt.xlabel('Dataset', fontsize=22)
# plt.ylabel('Radial RMSE Lat-Lon (m, log)', fontsize=22)
# plt.yscale('log')
# plt.xticks(rotation=45, fontsize=18)
# plt.yticks(fontsize=18)
# plt.legend(fontsize=18)
...
# # Add font sizes
# plt.title('Radial Error for Various Planar Transformations', fontsize=26)
# plt.xlabel('Dataset', fontsize=22)
...
# # Title and labels for Runtime
# plt.title('Runtime Comparison Across Datasets for Planar Transformation Methods', fontsize=26)
# plt.xlabel('Dataset', fontsize=22)
