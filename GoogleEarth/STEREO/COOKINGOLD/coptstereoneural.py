...
class ImageAlignerAndDepthMap:
    ...
    def compute_pixel_shift_heatmap(self, img_left, img_right, keypoints_left, keypoints_right, good_matches):
        ...
        for match in good_matches:
            ...
            heatmap[pt1[1] - 4:pt1[1] + 5, pt1[0] - 4:pt1[0] + 5] = shift
    ...
    def compute_depth_map(self, img_left, img_right):
        try_disp = [6, 27, 35, 44, 88]  # Depth ranges
        try_window_size = [2, 3, 5, 10]  # Smoothness settings
...
def main():
    ...
    imgLeftPath = os.path.join(root, 'chess1.png')
    imgRightPath = os.path.join(root, 'chess2.png')
